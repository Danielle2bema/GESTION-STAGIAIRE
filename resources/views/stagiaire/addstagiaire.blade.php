                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    @csrf
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1"></label>
                        <input type="file" name="photo" class="form-control" id="exampleInputName1" placeholder="Entrer une photo">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1"></label>
                      ...
                      <div class="form-group">
                        <label for="exampleSelectGender">Rapport du stage</label>
                              <textarea name="rapport"  class="form-control" cols="30" rows="10"></textarea>
                      </div>
